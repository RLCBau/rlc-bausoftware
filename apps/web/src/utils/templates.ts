...
export type VorlageEinheit = "m" | "m²" | "m³" | "Stk";

export type VorlageDefaults = Record<string, number | string>;
...
export type Vorlage = {
  ...
  beschreibung: string;
  formel: string;
  einheit: VorlageEinheit;
  beispiel?: string;
  defaults?: VorlageDefaults;
};
...
export function findAufmassVorlageById(id: string): Vorlage | undefined {
