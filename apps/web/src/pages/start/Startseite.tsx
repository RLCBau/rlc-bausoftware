...
export default function Startseite() {
  return (
    <main className={rlcClass(null, shell)}>
      <div className={rlcClass(null, bg)} />
      <div className={rlcClass(null, gradient)} />
      ...
      <section className={rlcClass(null, card)}>
        <img
          ...
          alt="Lo Curto â€“ Wappen" className="rlc-migrated-pages-start-startseite-tsx-1565" />
        ...
        <p className={rlcClass(null, subtitle)}>
          Die <b>RLC Bausoftware</b> ist die neue intelligente Plattform fÃ¼r
          <b> Kalkulation</b>, <b>Massenermittlung</b>, <b>CAD</b>,{" "}
          <b>BÃ¼ro / Verwaltung</b>, <b>KI</b>, <b>Info / Hilfe</b> und{" "}
          <b>Buchhaltung</b>. Ziel ist eine durchgÃ¤ngige, moderne und
        ...
        <div className={rlcClass(null, ctas)}>
          <Link to="/kalkulation" style={btn("primary")}>
            â†’ Kalkulation starten
          </Link>
          <Link to="/mengenermittlung/aufmasseditor" style={btn("ghost")}>
            Massenermittlung Ã¶ffnen
          </Link>
