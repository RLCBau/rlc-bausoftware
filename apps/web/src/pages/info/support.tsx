  ...
  return (
    <div style={shell}>
      <div style={headerCard}>
        <h2 style={{ margin: "0 0 8px" }}>Support / Chat</h2>
        <div style={{ color: "#334155", fontSize: 14, lineHeight: 1.45 }}>
      ...
      <div style={chatWrap}>
        <div ref={boxRef} style={messagesBox}>
          {messages.map((m) => {
        ...
        <div style={composer}>
          ...
          <div style={smallInfo}>{status || "Bereit."}</div>
        </div>
      </div>
    </div>
  );
