        ...
        <section className={rlcClass(null, heroWrap)}>
          <div className={rlcClass(null, heroGrid)}>
            <div>
              ...
              <h1 className={rlcClass(null, heroTitle)}>Eine Lizenzstruktur für Baustelle, Büro und CAD</h1>
              <p className={rlcClass(null, heroSub)}>
                Von der mobilen Baustellenerfassung bis zur vollständigen Web-, CAD-
                und Cloud-Lösung. Alle Bereiche arbeiten in derselben Projektstruktur.
              </p>
          ...
          <div className={rlcClass(null, cardsGrid)}>
            ...
            <div className={rlcClass(null, cardBase)}>
              ...
              <ul className={rlcClass(null, list)}>
                ...
                <li className={rlcClass(null, listItem)}>
                  <Check /> Zentraler Web-Zugriff für Archiv und Download
                </li>
                <li className={rlcClass(null, listItem)}>
            ...
            <div className={rlcClass(null, cardFeatured)}>
              ...
              <p className={rlcClass(null, cardDesc)}>
                Das vollständige System für Baustelle und Büro mit professionellem CAD,
                Mengenermittlung, KI-Kalkulation, Verwaltung und zentralem Datenzugriff.
              </p>
              ...
              <ul className={rlcClass(null, list)}>
                ...
                <li className={rlcClass(null, listItem)}>
                  <Check /> Vollständige Web-App für Büro, CAD und Verwaltung
                </li>
                <li className={rlcClass(null, listItem)}>
                  <Check /> Kalkulation, LV, KI und Mengenermittlung
                </li>
                <li className={rlcClass(null, listItem)}>
                  <Check /> CAD: DXF/DWG, Layer, Objektfang, UTM und Georeferenzierung
                </li>
                <li className={rlcClass(null, listItem)}>
                  <Check /> REB-Aufmaß, Regie, Lieferscheine, Fotos und Arbeitszeiten
                </li>
                <li className={rlcClass(null, listItem)}>
                  <Check /> Angebote, Nachträge, Rechnungen und Verwaltung
                </li>
                <li className={rlcClass(null, listItem)}>
            ...
            <div className={rlcClass(null, cardEnterprise)}>
              ...
              <ul className={rlcClass(null, list)}>
                ...
                <li className={rlcClass(null, { ...listItem, color: COLORS.white })}>
                  <Check dark /> Mobile + Web + CAD in eigener Infrastruktur
                </li>
                <li className={rlcClass(null, { ...listItem, color: COLORS.white })}>
          ...
          <div className={rlcClass(null, faqGrid)}>
            ...
            <div className={rlcClass(null, faqCard)}>
              ...
              <p className={rlcClass(null, { margin: 0, color: COLORS.sub, lineHeight: 1.6 })}>
                ...
                Server, eigener Infrastruktur, CAD-Arbeitsplätzen und individueller Einführung.
              </p>
            </div>
          </div>
        </section>
