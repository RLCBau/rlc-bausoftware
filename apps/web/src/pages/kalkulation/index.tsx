  ...
  return (
    <div className={rlcClass(null, shell)}>
      <aside className={rlcClass(null, aside)}>
        <div className={rlcClass(null, brandBox)}>
          <div className={rlcClass(null, brandEyebrow)}>RLC Bausoftware</div>
          <div className={rlcClass(null, brandTitle)}>Kalkulation</div>
          <div className={rlcClass(null, brandText)}>
            LV, Preise, KI-Kalkulation, Angebot und NachtrÃ¤ge.
          </div>
        </div>

        <nav className={rlcClass(null, nav)}>
          {groups.map((group) =>
          <div key={group.title} className={rlcClass(null, groupBox)}>
              <div className={rlcClass(null, groupTitle)}>{group.title}</div>
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    <span className={rlcClass(null, itemLabel)}>{entry.label}</span>
                    {entry.desc ?
                  <span className={rlcClass(null, itemDesc)}>{entry.desc}</span> :
                  null}
                  </Link>);
