          ...
          <div className="regie-field span-12">
            ...
            <div className="regie-attachments">
              ...
              <div className="regie-thumb" key={ph.id}>
                  {isImg(ph.type) ?
                <img src={withApiBase(ph.url)} alt={ph.name} onClick={() => setPreviewUrl(withApiBase(ph.url))} /> :

                <a href={withApiBase(ph.url)} target="_blank" rel="noreferrer" className="rlc-migrated-pages-mengenermittlung-regieberichte-tsx-1327">
