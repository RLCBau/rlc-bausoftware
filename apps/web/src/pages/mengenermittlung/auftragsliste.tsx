...
type Auftrag = {
  ...
  projektId: string;
  aufmassCount?: number; // ✅ nuovo campo
};
...
const DEMO: Auftrag[] = [
  {
    id: "A-1001",
    bezeichnung: "TW-BA-III – Trinkwasserleitung BA III",
    bauleiter: "M. König",
    ort: "D-81234",
    status: "laufend",
    projektId: "PROJ-001",
  ...
  {
    id: "A-1002",
    bezeichnung: "Straßenausbau Musterstraße",
    bauleiter: "S. Kramer",
    ort: "D-73321",
    status: "offen",
    projektId: "PROJ-002",
  ...
  {
    id: "A-1003",
    bezeichnung: "Gehweg Sanierung Süd",
    bauleiter: "A. Roth",
    ort: "D-70180",
...
export default function Auftragsliste() {
  ...
  useEffect(() => {
    setItems((prev) =>
      prev.map((a) => {
        ...
        return {
          ...a,
          aufmassCount: doc?.zeilen?.length || 0,
        };
      })
    );
  }, []);
  ...
  return (
    <div style={shell}>
      ...
      <div style={toolbar}>
        <input
          placeholder="Suche (Auftrag / Ort / ProjektID …)"
          style={textInput}
          value={q}
          onChange={(e) => setQ(e.target.value)}
        />
        <button style={btn} onClick={() => setQ("")}>
          Zurücksetzen
        </button>
      </div>
          ...
          <tbody>
            {filtered.map((a) => (
              <tr key={a.id}>
                ...
                <td style={thtd}>
                  {a.bezeichnung}
                  {a.aufmassCount && a.aufmassCount > 0 && (
                    <span
                      style={{
                        marginLeft: 6,
                        fontSize: 11,
                ...
                <td style={thtd}>
                  <button
                    ...
                    onClick={() =>
                      nav(
                        `/mengenermittlung/aufmasseditor?projectId=${encodeURIComponent(
                          a.projektId
                        )}`
                      )
                    }
