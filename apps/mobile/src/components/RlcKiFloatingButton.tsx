...
export default function RlcKiFloatingButton({
  ...
  useEffect(() => {
    ...
    const blocked = currentScreen.includes("SupportChat") || currentScreen.includes("RlcCopilot") || currentScreen.includes("Login") || currentScreen.includes("Start");
    if (blocked) return;
