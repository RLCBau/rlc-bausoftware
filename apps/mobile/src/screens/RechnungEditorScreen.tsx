  ...
  return <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.wrap}>
        ...
        <View style={s.formCard}>
          <Text style={s.formSectionTitle}>Rechnungsdaten</Text>
        ...
        <View style={s.formCard}>
          <Text style={s.formSectionTitle}>Steuer</Text>
          <Input label="Steuer-Nr." v={doc.steuerNr} k="steuerNr" set={setDoc} />
        ...
        <View style={s.formCard}>
          <Text style={s.formSectionTitle}>Positionen</Text>
        ...
        <View style={s.formCard}>
          <Text style={s.formSectionTitle}>Bemerkung</Text>
