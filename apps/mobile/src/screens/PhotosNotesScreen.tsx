...
export default function PhotosNotesScreen({
  ...
  }, [readMode, loadEditIfNeeded, localStoreKey, inboxProjectKey, baKey, editId, fromInbox, initialSnapshot?.id]));
  ...
  }, [buildRow, readMode, localStoreKey, addToInboxQueueOffline, inboxProjectKey, localKey]);
  ...
  }, [buildRow, readMode, localStoreKey, addToInboxQueueOffline, ensureServerAllowed, fromInbox, navigation, baKey, inboxProjectKey, localKey]);
      ...
      <ScrollView contentContainerStyle={styles._inline1}>
        <View style={styles.pageHeading}>
          <View style={styles._inline2}>
            ...
            <Text style={styles.sub}>{baKey || projectTitle}</Text>
          </View>
