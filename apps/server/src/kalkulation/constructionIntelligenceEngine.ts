  ...
  const annotated = {
    ...
    constructionIntelligence: {
      ...
      decisionReasons: [
        ...
        `Quelle: ${
          normalizeSource(originalSource) || "existing-calculation"
        }.`,
