...
export function formatSoftwareIntelligenceContext(
  ...
  return [
    ...
    "- Konkrete Navigationsschritte nur nennen, wenn sie durch UI-Texte oder UI-Routen der Treffer ausdr\u00fccklich belegt sind.",
    "- Eine technische ROUTE oder ein Server-Treffer belegt keine Benutzeroberfl\u00e4che und keine Bedienfolge.",
