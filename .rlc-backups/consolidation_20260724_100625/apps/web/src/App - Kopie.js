...
import GPSZuweisung from "./pages/mengenermittlung/gps";
...
const SECTIONS = [
    {
        ...
        items: [
            ...
            { key: "preise", label: "Preise einfügen (Material/Arbeiter/Maschinen)" },
    ...
    },
    {
        ...
        items: [
            ...
            { key: "aufmasse", label: "Aufmaße eintragen (Linien, Maßeinheiten…)" },
            ...
            { key: "aufmass", label: "Aufmass (CAD Inbox)" },
        ],
    },
    {
        key: "cad",
