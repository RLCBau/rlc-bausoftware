...
export default function LVOhnePreis() {
    ...
    return (_jsxs("div", { style: shell, children: [_jsx("h2", { style: { margin: "4px 0 12px", fontSize: 20, fontWeight: 700 }, children: "LV ohne Preise exportieren" }), _jsx("button", { style: btn, onClick: exportCsv, children: "CSV exportieren" })] }));
}
