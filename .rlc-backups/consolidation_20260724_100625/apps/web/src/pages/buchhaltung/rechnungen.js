...
const offen = (r) => Math.max(0, brutto(r) - (r.gezahlt || 0));
const statusOf = (r) => {
    const b = brutto(r);
    if ((r.gezahlt || 0) <= 0.01)
        return "OPEN";
    if ((r.gezahlt || 0) >= b - 0.01)
        return "PAID";
    return "PART";
};
const parseDate = (s) => {
...
export default function Rechnungen() {
    ...
    return (_jsxs("div", { className: "bh-page", children: [_jsxs("div", { className: "bh-header-row", children: [_jsx("h2", { children: "Rechnungen / Abschl\u00E4ge" }), _jsxs("div", { className: "bh-actions", children: [_jsx("button", { className: "bh-btn", onClick: addRow, children: "+ Neue Rechnung" }), _jsx("button", { className: "bh-btn ghost", onClick: () => exportCSV(true), children: "Export CSV (gefiltert)" }), _jsx("button", { className: "bh-btn ghost", onClick: () => exportCSV(false), children: "Export CSV (alle)" }), _jsx("button", { className: "bh-btn ghost", onClick: () => printAllPDF(true), children: "PDF Report (gefiltert)" }), _jsx("button", { className: "bh-btn ghost", onClick: () => printAllPDF(false), children: "PDF Report (alle)" }), _jsx("button", { className: "bh-btn ghost", onClick: () => downloadAllPDF(filtered), children: "Download PDF (gefiltert)" }), _jsx("button", { className: "bh-btn ghost", onClick: () => downloadAllPDF(rows), children: "Download PDF (alle)" }), _jsx("button", { className: "bh-btn ghost", onClick: () => downloadSinglePDF(r), children: "Download" })] })] }), _jsxs("div", { className: "bh-filters", children: [_jsxs("div", { children: [_jsx("label", { children: "Zeitraum" }), _jsxs("select", { value: zeitraum, onChange: e => setZeitraum(e.target.value), children: [_jsx("option", { value: "THIS_MONTH", children: "Dieser Monat" }), _jsx("option", { value: "30", children: "Letzte 30 Tage" }), _jsx("option", { value: "60", children: "Letzte 60 Tage" }), _jsx("option", { value: "90", children: "Letzte 90 Tage" }), _jsx("option", { value: "YTD", children: "YTD" }), _jsx("option", { value: "ALL", children: "Alle" })] })] }), _jsxs("div", { children: [_jsx("label", { children: "Kunde" }), _jsx("select", { value: kunde, onChange: e => setKunde(e.target.value), children: kundenListe.map(k => _jsx("option", { value: k, children: k }, k)) })] }), _jsxs("div", { children: [_jsx("label", { children: "Status" }), _jsxs("select", { value: status, onChange: e => setStatus(e.target.value), children: [_jsx("option", { value: "ALL", children: "Alle" }), _jsx("option", { value: "OPEN", children: "Offen" }), _jsx("option", { value: "PART", children: "Teilbezahlt" }), _jsx("option", { value: "PAID", children: "Bezahlt" })] })] })] }), _jsxs("table", { className: "bh-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Aktionen" }), _jsx("th", { children: "Nr." }), _jsx("th", { children: "Datum" }), _jsx("th", { children: "F\u00E4llig" }), _jsx("th", { children: "Kunde" }), _jsx("th", { children: "Netto (\u20AC)" }), _jsx("th", { children: "MWSt (%)" }), _jsx("th", { children: "Brutto (\u20AC)" }), _jsx("th", { children: "Gezahlt (\u20AC)" }), _jsx("th", { children: "Offen (\u20AC)" }), _jsx("th", { children: "Status" }), _jsx("th", { children: "PDF" })] }) }), _jsxs("tbody", { children: [filtered.map((r, iFiltered) => {
                                const idx = rows.findIndex(x => x.id === r.id);
                                return (_jsxs("tr", { children: [_jsx("td", { children: _jsxs("div", { style: { display: "flex", gap: 6 }, children: [_jsx("button", { className: "bh-btn ghost", onClick: () => duplicate(r), children: "Duplizieren" }), _jsx("button", { className: "bh-btn", style: { background: "#e74c3c" }, onClick: () => remove(r.id), children: "L\u00F6schen" })] }) }), _jsx("td", { children: r.nr }), _jsx("td", { children: _jsx("input", { type: "text", value: r.datum, onChange: (e) => update(idx, "datum", e.target.value), title: "dd.mm.yyyy oder ISO", style: { width: 110 } }) }), _jsx("td", { children: _jsx("input", { type: "text", value: r.faellig || "", onChange: (e) => update(idx, "faellig", e.target.value), style: { width: 110 } }) }), _jsx("td", { children: _jsx("input", { type: "text", value: r.kunde, onChange: (e) => update(idx, "kunde", e.target.value), style: { minWidth: 160 } }) }), _jsx("td", { children: _jsx("input", { type: "number", step: "0.01", value: r.netto, onChange: (e) => update(idx, "netto", parseFloat(e.target.value)), style: { width: 110 } }) }), _jsx("td", { children: _jsx("input", { type: "number", step: "0.1", value: r.mwstPct, onChange: (e) => update(idx, "mwstPct", parseFloat(e.target.value)), style: { width: 80 } }) }), _jsx("td", { children: fmt(brutto(r)) }), _jsx("td", { children: _jsx("input", { type: "number", step: "0.01", value: r.gezahlt, onChange: (e) => update(idx, "gezahlt", parseFloat(e.target.value)), style: { width: 110 } }) }), _jsx("td", { style: { fontWeight: 600 }, children: fmt(offen(r)) }), _jsx("td", { children: _jsx(StatusChip, { value: statusOf(r) }) }), _jsx("td", { children: _jsx("button", { className: "bh-btn ghost", onClick: () => printSinglePDF(r), children: "PDF" }) })] }, r.id));
                            }), _jsxs("tr", { style: { background: "#fafafa", fontWeight: 600 }, children: [_jsx("td", { colSpan: 5, style: { textAlign: "right" }, children: "Gesamt (gefiltert):" }), _jsx("td", { children: fmt(totals.netto) }), _jsx("td", { children: fmt(totals.mwstSum) }), _jsx("td", { children: fmt(totals.brut) }), _jsx("td", { children: fmt(totals.gez) }), _jsx("td", { children: fmt(totals.off) }), _jsx("td", { colSpan: 2 })] })] })] }), _jsx("div", { className: "bh-note", style: { marginTop: 8 }, children: "*Tip: F\u00FCr reale Daten binde hier eure Stores/Backend an (Projekt-ID)." })] }));
}
/* ===== UI Helpers ===== */
