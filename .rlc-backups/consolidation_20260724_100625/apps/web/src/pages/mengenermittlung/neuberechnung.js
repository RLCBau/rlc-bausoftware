...
export default function Neuberechnung() {
    ...
    return (_jsxs("div", { style: shell, children: [_jsx("h2", { style: { margin: "4px 0 12px", fontSize: 20, fontWeight: 700 }, children: "Neuberechnung" }), _jsxs("div", { style: { marginBottom: 10 }, children: [_jsx("input", { value: projekt, onChange: (e) => setProjekt(e.target.value), style: input }), _jsx("button", { style: btn, onClick: run, children: "Neuberechnung starten" })] }), _jsx("div", { style: area, children: log })] }));
}
