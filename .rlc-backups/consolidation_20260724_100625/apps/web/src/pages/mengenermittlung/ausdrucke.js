...
export default function Ausdrucke() {
    ...
    const csv = () => {
        ...
        a.download = `Aufmass_${projekt}.csv`;
        a.click();
        URL.revokeObjectURL(a.href);
    };
    const drucken = () => window.print();
    return (_jsxs("div", { style: shell, children: [_jsx("h2", { style: { margin: "4px 0 12px", fontSize: 20, fontWeight: 700 }, children: "Ausdrucke" }), _jsxs("div", { style: { marginBottom: 10 }, children: [_jsx("input", { value: projekt, onChange: (e) => setProjekt(e.target.value), style: input }), _jsx("button", { style: btn, onClick: csv, children: "CSV Export" }), " ", _jsx("button", { style: btn, onClick: drucken, children: "Drucken (Browser)" })] }), _jsx("div", { style: { color: "#64748b", fontSize: 12 }, children: "F\u00FCr PDF bitte die Druckfunktion des Browsers verwenden (Ziel \u201EAls PDF speichern\u201C)." })] }));
}
