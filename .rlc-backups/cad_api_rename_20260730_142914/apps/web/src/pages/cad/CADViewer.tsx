...
/* =========================================================
   ...
   - Direct ASCII DXF import without RLC CAD
...
export default function CADViewer() {
  ...
  const exportDxf = () => {
    ...
    // den der RLC-Importer zuverlässig lesen kann und RLC CAD direkt öffnet.
    const rows: string[] = [];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* AutoCAD/RLC CAD-style command bar inside the drawing area */}
            <div
